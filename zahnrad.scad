...
// zahnstange_und_rad (modul=1, laenge_stange=50, zahnzahl_rad=20, hoehe_stange=4, bohrung_rad=4, breite=5, eingriffswinkel=20, schraegungswinkel=0, zusammen_gebaut=true, optimiert=true);
